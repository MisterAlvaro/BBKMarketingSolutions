      ...
      <main className="pt-24">
        <section className="py-20">
          <div className="container mx-auto px-4">
            <h1 className="text-4xl font-bold mb-8 text-center">Social media management and content generation services.</h1>
            <p className="text-xl mb-12 text-center max-w-3xl mx-auto">
             BBK Marketing Solutions offers, through a multidisciplinary team, social media management and content generation services. Our services include:
            </p>
              ...
              <div>
                ...
                <ul className="space-y-4">
                  <li className="flex items-center">
                    ...
                    <span>Creation of attractive and relevant content (texts, images, videos) all under copyright.</span>
                  </li>
                  <li className="flex items-center">
                    <Check className="mr-2 text-[#e34c0d]" />
                    <span>Development of customized social media strategies.</span>
                  </li>
                  <li className="flex items-center">
                    <Check className="mr-2 text-[#e34c0d]" />
                    <span>Social media administration and moderation.</span>
                  </li>
                  <li className="flex items-center">
                    <Check className="mr-2 text-[#e34c0d]" />
                    <span>Analysis and monitoring of metrics and performance.</span>
                  </li>
                  <li className="flex items-center">
                    <Check className="mr-2 text-[#e34c0d]" />
                    <span>Optimizing social media posts and ads.</span>
                  </li>
                </ul>
              </div>
              <div>
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-4 gap-8">
              {[
                {
                  title: "Increase your presence on social networks",
                },
                {
                  title: "Increase interaction and engagement with your audience",
                },
                {
                  title: "Generate leads and sales through social networks",
                },
                {
                  title: "Improve your online reputation and brand",
                },
              ].map((step, index) => (
        ...
        <section className="py-20">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl font-bold mb-8">Ready to dominate social media?</h2>
